...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2026 at 07:59 AM
...
INSERT INTO `tb_pengguna` (`id_pengguna`, `nama_lengkap`, `username`, `password`, `hak_akses`) VALUES
(1, 'Dwi Sekar Andini', 'sekar', 'admin123', 'admin'),
(2, 'Adelia Dwi Arafah', 'adelia', 'user123', 'user'),
(3, 'Delphia Oktaviani', 'delphia', 'user123', 'user');
